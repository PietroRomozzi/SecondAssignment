...
with only five. Also the Italian Statistical Agency adopts this categorization in various cases and some of the databases we are 
going to use already include data divided according to this idea of clustering homogeneous Italian regions together. 
